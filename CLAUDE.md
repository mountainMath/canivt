...
**The refusal ledger is empty** (2026-07-26): all 171 corpus rows are
...
and a new failure trip the test) and the exact non-zero cell count. 171 tables,
