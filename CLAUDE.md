...
- **The bitmap addresses members by SLOT, and slots can have holes.** The survey
  ...
  and `ivt_f2_dim_slot_expand()` is only the fallback where no table parses. When
